...
public class Spending_Two_Clean_MW {
    ...
    public static void main(String[] args) throws VerificationFailedException {
        ...
        OneOutOfManyWitnessMW oneOutOfManyWitnessMW1 = new OneOutOfManyWitnessMW(N-1, shielded_coin1, output_coin1);
        ...
        OneOutOfManyWitnessMW oneOutOfManyWitnessMW2 = new OneOutOfManyWitnessMW(N-1, shielded_coin2, output_coin2);
