...
public class Spending_One_of_each_Clean_V2_MW {
    ...
    public static void main(String[] args) throws VerificationFailedException {
        ...
        DoubleBlindedPedersenCommitment publishedSource = serialNumber.add(LelantusUtils.getDBPedersen(params, BigInteger.ZERO, BigInteger.ZERO, private_A));

        // Everybody can calculate the published source
        GroupElement testAIsUsed = serialNumber.getCommitment().add(public_A);
