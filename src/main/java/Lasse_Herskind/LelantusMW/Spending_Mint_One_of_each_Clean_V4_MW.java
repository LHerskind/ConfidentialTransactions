...
public class Spending_Mint_One_of_each_Clean_V4_MW {
    ...
    public static void main(String[] args) throws VerificationFailedException {
        ...
        GroupElement Q = params.getBase().j.multiply(q);
        ...
        DoubleBlindedPedersenCommitment publishedSource = output_coin.add(LelantusUtils.getDBPedersen(params, BigInteger.ZERO, BigInteger.ZERO, private_A.add(q)));
        if (!(output_coin.getCommitment().add(public_A).add(Q)).equals(publishedSource.getCommitment())) {
        ...
        GroupElement Q_mint = params.getBase().j.multiply(q_mint);
        ...
        // Ensuring that we are able to spend the inputs we want to move to the shielded pool
        ...
        System.out.println("Cut-through:");
        System.out.println("\t" + output_coin);
        System.out.println("\t" + to_shield);
        System.out.println("Inputs: ");
        System.out.println("\t" + normalSource);
        System.out.println("\t" + publishedSource);
        System.out.println("Outputs: ");
        System.out.println("\t" + normalDestination);
        System.out.println("\t" + shieldedCoinNew);
        ...
        System.out.println("Excess: " + excess.getCommitment().stringRepresentation());
        System.out.println("Excess with Q and A:" + excess.add(publishedSource).sub(output_coin).getCommitment().subtract(Q.add(public_A)).stringRepresentation());
