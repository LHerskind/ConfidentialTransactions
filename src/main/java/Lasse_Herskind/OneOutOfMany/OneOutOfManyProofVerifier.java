...
public class OneOutOfManyProofVerifier<T extends GroupElement<T>> implements Verifier<DoubleGeneratorParams<T>, T[], OneOutOfManyProof<T>> {
    @Override
    public void verify(DoubleGeneratorParams<T> params, T[] CMList, OneOutOfManyProof<T> proof) throws VerificationFailedException {
        ...
        GroupElement comm = getDBPedersen(params, BigInteger.ZERO, proof.getzV(), proof.getzR()).getCommitment();
